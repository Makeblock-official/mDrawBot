#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe mDraw.py -W setup.py
...
mDraw = Target(
    ...
    script="mDraw.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'mDraw'
    # dest_base = "mDraw",
